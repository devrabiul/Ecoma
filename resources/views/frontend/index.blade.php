...
<!-- slider-area -->
<section class="second-slider-area" data-background="{{ asset('frontend_assets/img/slider/slider_bg.jpg')}}">
    <div class="custom-container-two">
        <div class="row justify-content-end">
            <div class="col-xl-10">
                <div class="slider-active">
                    <div class="single-slider slider-bg" data-background="{{ asset('frontend_assets/img/slider/s_slider_bg01.jpg')}}">
                    ...
                    <div class="single-slider slider-bg" data-background="{{ asset('frontend_assets/img/slider/s_slider_bg02.jpg')}}">
                        <div class="slider-content">
                            <h5 data-animation="fadeInUp" data-delay=".3s">top deal !</h5>
                    ...
                    <div class="single-slider slider-bg" data-background="{{ asset('frontend_assets/img/slider/s_slider_bg03.jpg')}}">
                        <div class="slider-content">
                            <h5 data-animation="fadeInUp" data-delay=".3s">top deal !</h5>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="top-cat-banner-item mt-30">
                    <a href="{{$banner->category_id}}"><img class="img-fluid" src="{{ asset('uploads/banners')}}/{{$banner->thumbnail}}" alt=""></a>
                </div>
            </div>
        ...
        <div class="row exclusive-active">
                ...
                <div class="exclusive-item exclusive-item-two mb-40">
                    <div class="exclusive-item-thumb">
                        <a href="shop-details.html">
                            <img src="{{ asset('frontend_assets/img/product/s_exclusive_product01.png')}}" alt="">
                            <img class="overlay-product-thumb" src="{{ asset('frontend_assets/img/product/s_exclusive__product01.png')}}" alt="">
                        </a>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one cat-three">
                <div class="exclusive-item exclusive-item-two mb-40">
                    <div class="exclusive-item-thumb">
                        <a href="shop-details.html">
                            <img src="{{ asset('frontend_assets/img/product/s_exclusive_product02.png')}}" alt="">
                            <img class="overlay-product-thumb" src="{{ asset('frontend_assets/img/product/s_exclusive__product02.png')}}" alt="">
                        </a>
                        <span class="sd-meta">New!</span>
                        <a href="cart.html" class="to-cart">add to cart <i class="fas fa-cart-plus"></i></a>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                <div class="exclusive-item exclusive-item-two mb-40">
                    <div class="exclusive-item-thumb">
                        <a href="shop-details.html">
                            <img src="{{ asset('frontend_assets/img/product/s_exclusive_product03.png')}}" alt="">
                            <img class="overlay-product-thumb" src="{{ asset('frontend_assets/img/product/s_exclusive__product03.png')}}" alt="">
                        </a>
                        <span class="sd-meta">New!</span>
                        <a href="cart.html" class="to-cart">add to cart <i class="fas fa-cart-plus"></i></a>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one cat-three">
                <div class="exclusive-item exclusive-item-two mb-40">
                    <div class="exclusive-item-thumb">
                        <a href="shop-details.html">
                            <img src="{{ asset('frontend_assets/img/product/s_exclusive_product04.png')}}" alt="">
                            <img class="overlay-product-thumb" src="{{ asset('frontend_assets/img/product/s_exclusive__product04.png')}}" alt="">
                        </a>
                        <span class="sd-meta">New!</span>
                        <a href="cart.html" class="to-cart">add to cart <i class="fas fa-cart-plus"></i></a>
                    </div>
